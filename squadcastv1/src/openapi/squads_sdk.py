...
from openapi.squads_members import SquadsMembers
...
class SquadsSDK(BaseSDK):
    ...
    def get_by_team(
        ...
        *,
    ...
    ) -> List[models.V3SquadsSquadResponse]:
        r"""Get Squad By team
        ...
        request = models.SquadsGetSquadByTeamRequest(
            owner_id=owner_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Squads_getSquadByTeam",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.SquadsGetSquadByTeamResponse, http_res
            )
    ...
    def update(
        ...
        *,
        ...
        request = models.SquadsUpdateSquadRequest(
            squad_id=squad_id,
            v3_squads_update_squad_request=models.V3SquadsUpdateSquadRequest(
                name=name,
                members=members,
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_squads_update_squad_request,
                False,
                False,
                "json",
                models.V3SquadsUpdateSquadRequest,
            ),
            timeout_ms=timeout_ms,
        )
    ...
    def get_by_id(
        ...
        *,
        ...
        request = models.SquadsGetSquadByIDV4Request(
            squad_id=squad_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Squads_getSquadByIdV4",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.SquadsGetSquadByIDV4Response, http_res
            )
        if utils.match_response(
            http_res,
            ["400", "401", "402", "403", "404", "409", "422"],
    ...
    def update_v4(
        ...
        *,
        ...
        request = models.SquadsUpdateSquadV4Request(
            squad_id=squad_id,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Squads_updateSquadV4",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.SquadsUpdateSquadV4Response, http_res)
        if utils.match_response(
            http_res,
            ["400", "401", "402", "403", "404", "409", "422"],
            "application/json",
